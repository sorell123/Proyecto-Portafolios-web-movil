...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <!-- Start feature Area --><br><br><br><br><br><br>
            <br><center><h1>Registrate Aqui</h1></center>
            <center><section class="feature-area section-gap" id="secvice">
                    <img src="img/proveedor.png" class="img-fluid" alt="" width="300" height="300"><br><br>
                    <a href="RegistrarCliente.jsp" class="genric-btn danger">CLIENTE</a>
