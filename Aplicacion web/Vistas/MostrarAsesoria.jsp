...
<html lang="zxx" class="no-js">
    ...
    <body>
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">Mostrar todos las Acesorias</h3>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Informacion de las Asesorias</h1></center><br>
            ...
            <% Connection con;
                ...
                ResultSet rs;
                ps = con.prepareStatement("SELECT * FROM CLIENTE5");
                rs = ps.executeQuery();
                //tabla
            %>
            <br> <center><table border="3" width="1000">
                    ...
                    <th><center>Tiempo de Asesoria(horas)</center></th>
