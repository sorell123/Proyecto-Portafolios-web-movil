                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li><a href="HacerPedido.jsp">Ver tickets</a></li>
                                <li><a href="RecibirPedido.jsp">editar inforamcion</a></li>
                                <!-- Dropdown -->
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="generic-banner-content"><br>
                            <h3 class="text-white">Bienvenido ${usuario} a Cuenta Profecional</h3>
