...
<html lang="zxx" class="no-js">
    ...
    <body>
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">"No mas accidentes" te invita a Registrarte y disfruta de nuestros beneficios</h3>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Registrate como cliente Aqui</h1></center><br>

            <div> <center><form action="AgregarCliente" method="post">
                        <input type="text" style="width : 450px; heigth : 450px" name="txtRut" placeholder="Rut Empresa" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Rut'" required class="single-input"><label>-</label><input type="text" style="width : 50px; heigth : 50px" name="txtDv" placeholder="Dv" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Dv'" required class="single-input">
                        <br>
                        <input type="text" style="width : 500px; heigth : 500px" name="txtNombre" placeholder="Nombre Cliente" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nombre'" required class="single-input">
                        <br>
                        ...
                        <br>
                        <input type="password" style="width : 500px; heigth : 500px" name="txtContrasena" placeholder="Contraseña" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Contrasena'" required class="single-input">
                        <br>
