...
<html lang="zxx" class="no-js">
    ...
    <body>
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">Mostrar todas todos los profecionales</h3>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Informacion de los profecionales</h1></center><br>
            ...
            <br> <center><table border="3" width="1000">
                    ...
                    <td>
                        &nbsp;&nbsp;&nbsp;
                    <center> <a href="EliminarHabitacion.jsp?id=<%=rs.getString("id")%>" onclick="confirm('¡¡ESTA SEGURO QUE DESEA ELIMINAR AL PROFESIONAL!!')" ><img src="img/eliminar.png" width="40" height="40"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="EliminarVuelo.jsp?ID=<%=rs.getString("id")%>" onclick="confirm('¡¡ESTA SEGURO QUE DESEA ELIMINAR AL PROFESIONAL!!')"><img src="img/editar.png" width="40" height="40"></a></center>
                    </td>                         
                    </tr>
                    <%}%> 
                </table>
