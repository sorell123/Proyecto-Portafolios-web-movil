                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">Registro Exitoso, Ya puedes ingresar a tu perfil</h3>
                            <br>
                            <a href="Ingresar.jsp"><input type="button" name="btnIngresar" value="Ingresar" class="primary-btn text-uppercase" ></a>
                            <br>
                            <br>
                            <br>
                            <br>   
