...
<html lang="zxx" class="no-js">
    ...
    <body>
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">Clarita Hotel te da la bienvenida a cuenta de administador</h3>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Se ha creado empleado</h1></center><br>

                    <div> <center>
                           <img src="img/tick.png" alt="" width="200" height="200">
                </center></div> 
