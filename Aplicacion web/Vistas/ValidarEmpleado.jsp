                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="RegistrarEmpleado.jsp">Profecionales</a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="RegistrarProveedor.jsp">Tickets</a>
                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="generic-banner-content">
                            ...
                            <h3 class="text-white">Registro Exitoso, Empleado registrado correctamente</h3>
                            <br>
                            <a href="loginAdmin.jsp"><input type="button" name="btnIngresar" value="Volver a inicio" class="primary-btn text-uppercase" ></a>
                            <br>
                            <br>
                            <br>
                            <br>   
