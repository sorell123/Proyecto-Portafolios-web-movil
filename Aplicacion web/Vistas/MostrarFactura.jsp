...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Informacion de Facturas</h1></center><br>
            ...
            <br> <center><table border="3" width="1000">
                    ...
                    <td><center><%=rs.getString("descripcion")%></center></td>
                    <td><center><a>$ </a><%=rs.getInt("total")%></center></td>
                    <td><center><%=rs.getInt("id_compra")%></center></td>
                    <td>
                        &nbsp;&nbsp;&nbsp;
