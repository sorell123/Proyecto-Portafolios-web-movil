                ...
                <div class="row height align-items-center justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="generic-banner-content">
                            <img src="img/check.png" width="300" height="300">
                            <h3 class="text-white">Ingresado correctamente</h3>
                            <br>
                            <a href="loginEmpleado.jsp"><input type="button" name="btnIngresar" value="Volver" class="primary-btn text-uppercase" ></a>
                            <br>
                            <br>
                            <br>
                            <br>   
