...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <div class="main-wrapper" id="registro">
            ...
            <br><center><h1>Ingresa aqui tu respuesta</h1></center><br>

            <div> <center><form action="ValidarChekListCli.jsp" method="post">
                        <textarea name="comentario" rows="10" cols="40" placeholder="Respuesta" onblur="this.placeholder = 'Respuesta'"></textarea>
                        <br>
                        <br>
                         <input type="file" name="btnIngresar" value="Ingresa archivo" class="primary-btn text-uppercase">
                         <br>
                         <br>
