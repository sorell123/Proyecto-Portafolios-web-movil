...
public class AgregarProfesional extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Profesional pro = new Profesional(rut,dv,nombre,apellido,usuario,password);
            conecta.getConnection(); 
            agrega.agregaProfesional(pro);
        ...
        } catch (IOException | ClassNotFoundException | SQLException | ServletException e)
        {
           ...
           // request.setAttribute("mensaje", mensaje);
            RequestDispatcher despacha = request.getRequestDispatcher("ConfirmaAdmin.jsp");
            despacha.forward(request, response);
        }
    }
